    ...
    transition('void => *',
        animate('1000ms cubic-bezier(0.215, 0.610, 0.355, 1.000)',
            keyframes([
                ...
                style({ opacity: 1, height: '240px', offset: .6 }),
                style({ opacity: 1, height: '280px', offset: .7 }),
                style({ opacity: 1, height: '260px', offset: .9 }),
    ...
    transition('* => void',
        animate('1000ms cubic-bezier(0.215, 0.610, 0.355, 1.000)',
            keyframes([
                ...
                style({ opacity: 1, height: '50px', offset: .3 }),
                style({ opacity: 1, height: '70px', offset: .6 }),
